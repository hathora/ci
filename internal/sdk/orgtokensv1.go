...
// OrgTokensV1 -
type OrgTokensV1 struct {
	sdkConfiguration sdkConfiguration
}

func newOrgTokensV1(sdkConfig sdkConfiguration) *OrgTokensV1 {
	return &OrgTokensV1{
...
func (s *OrgTokensV1) GetOrgTokens(ctx context.Context, orgID string) (*operations.GetOrgTokensResponse, error) {
...
func (s *OrgTokensV1) CreateOrgToken(ctx context.Context, orgID string, createOrgToken shared.CreateOrgToken) (*operations.CreateOrgTokenResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *OrgTokensV1) RevokeOrgToken(ctx context.Context, orgID string, orgTokenID string) (*operations.RevokeOrgTokenResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
