...
func main() {
    ...
    res, err := s.BuildsV1.GetBuildsDeprecated(ctx, appID)
    if err != nil {
        log.Fatal(err)
    }
    if res.Builds != nil {
...
func main() {
    ...
    var appID *string = sdk.String("app-af469a92-5b45-4565-b3c4-b79878de67d2")
    ctx := context.Background()
    res, err := s.BuildsV1.GetBuildInfoDeprecated(ctx, buildID, appID)
    if err != nil {
        log.Fatal(err)
    }
    if res.Build != nil {
...
func main() {
    ...
    var appID *string = sdk.String("app-af469a92-5b45-4565-b3c4-b79878de67d2")
    ctx := context.Background()
    res, err := s.BuildsV1.CreateBuildDeprecated(ctx, createBuildParams, appID)
    if err != nil {
        log.Fatal(err)
    }
    if res.Build != nil {
...
func main() {
    ...
    var appID *string = sdk.String("app-af469a92-5b45-4565-b3c4-b79878de67d2")
    ctx := context.Background()
    res, err := s.BuildsV1.DeleteBuildDeprecated(ctx, buildID, appID)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    requestBody := operations.RunBuildDeprecatedRequestBody{
        File: operations.File{
            ...
            Content: []byte("0x96Cf4be63b"),
        },
    }

    var appID *string = sdk.String("app-af469a92-5b45-4565-b3c4-b79878de67d2")
    ctx := context.Background()
    res, err := s.BuildsV1.RunBuildDeprecated(ctx, buildID, requestBody, appID)
    if err != nil {
        log.Fatal(err)
    }
    if res.Res != nil {
