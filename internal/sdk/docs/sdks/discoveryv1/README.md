...
func main() {
    ...
    res, err := s.DiscoveryV1.GetPingServiceEndpoints(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.GetPingServiceEndpointsResponse](../../pkg/models/operations/getpingserviceendpointsresponse.md), error**
