...
func (s *LobbiesV3) CreateLobby(ctx context.Context, security operations.CreateLobbySecurity, createLobbyV3Params shared.CreateLobbyV3Params, appID *string, shortCode *string, roomID *string) (*operations.CreateLobbyResponse, error) {
...
func (s *LobbiesV3) ListActivePublicLobbies(ctx context.Context, appID *string, region *shared.Region) (*operations.ListActivePublicLobbiesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *LobbiesV3) GetLobbyInfoByRoomID(ctx context.Context, roomID string, appID *string) (*operations.GetLobbyInfoByRoomIDResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *LobbiesV3) GetLobbyInfoByShortCode(ctx context.Context, shortCode string, appID *string) (*operations.GetLobbyInfoByShortCodeResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
