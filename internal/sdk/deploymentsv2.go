...
func (s *DeploymentsV2) GetDeployments(ctx context.Context, appID *string) (*operations.GetDeploymentsResponse, error) {
...
func (s *DeploymentsV2) GetLatestDeployment(ctx context.Context, appID *string) (*operations.GetLatestDeploymentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *DeploymentsV2) GetDeploymentInfo(ctx context.Context, deploymentID int, appID *string) (*operations.GetDeploymentInfoResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *DeploymentsV2) CreateDeployment(ctx context.Context, buildID int, deploymentConfigV2 shared.DeploymentConfigV2, appID *string) (*operations.CreateDeploymentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
