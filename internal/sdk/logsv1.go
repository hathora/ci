...
func (s *LogsV1) GetLogsForApp(ctx context.Context, appID *string, follow *bool, tailLines *int, region *shared.Region, opts ...operations.Option) (*operations.GetLogsForAppResponse, error) {
...
func (s *LogsV1) GetLogsForProcess(ctx context.Context, processID string, appID *string, follow *bool, tailLines *int, opts ...operations.Option) (*operations.GetLogsForProcessResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *LogsV1) DownloadLogForProcess(ctx context.Context, processID string, appID *string, opts ...operations.Option) (*operations.DownloadLogForProcessResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *LogsV1) GetLogsForDeployment(ctx context.Context, deploymentID int, appID *string, follow *bool, tailLines *int, opts ...operations.Option) (*operations.GetLogsForDeploymentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
