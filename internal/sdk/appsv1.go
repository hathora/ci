...
func (s *AppsV1) GetApps(ctx context.Context) (*operations.GetAppsResponse, error) {
...
func (s *AppsV1) CreateApp(ctx context.Context, request shared.AppConfig) (*operations.CreateAppResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *AppsV1) UpdateApp(ctx context.Context, appConfig shared.AppConfig, appID *string) (*operations.UpdateAppResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *AppsV1) GetAppInfo(ctx context.Context, appID *string) (*operations.GetAppInfoResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *AppsV1) DeleteApp(ctx context.Context, appID *string) (*operations.DeleteAppResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
