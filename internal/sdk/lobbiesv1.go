...
func (s *LobbiesV1) CreatePrivateLobbyDeprecated(ctx context.Context, security operations.CreatePrivateLobbyDeprecatedSecurity, appID *string, region *shared.Region, local *bool) (*operations.CreatePrivateLobbyDeprecatedResponse, error) {
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *LobbiesV1) CreatePublicLobbyDeprecated(ctx context.Context, security operations.CreatePublicLobbyDeprecatedSecurity, appID *string, region *shared.Region, local *bool) (*operations.CreatePublicLobbyDeprecatedResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *LobbiesV1) ListActivePublicLobbiesDeprecatedV1(ctx context.Context, appID *string, local *bool, region *shared.Region) (*operations.ListActivePublicLobbiesDeprecatedV1Response, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
