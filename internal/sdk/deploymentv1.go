...
// DeploymentV1 - Deprecated. Use [DeploymentV2](https://hathora.dev/api#tag/DeploymentV2).
type DeploymentV1 struct {
	sdkConfiguration sdkConfiguration
}

func newDeploymentV1(sdkConfig sdkConfiguration) *DeploymentV1 {
	return &DeploymentV1{
...
func (s *DeploymentV1) GetDeploymentsDeprecated(ctx context.Context, appID *string) (*operations.GetDeploymentsDeprecatedResponse, error) {
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *DeploymentV1) GetLatestDeploymentDeprecated(ctx context.Context, appID *string) (*operations.GetLatestDeploymentDeprecatedResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *DeploymentV1) GetDeploymentInfoDeprecated(ctx context.Context, deploymentID int, appID *string) (*operations.GetDeploymentInfoDeprecatedResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *DeploymentV1) CreateDeploymentDeprecated(ctx context.Context, buildID int, deploymentConfig shared.DeploymentConfig, appID *string) (*operations.CreateDeploymentDeprecatedResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
