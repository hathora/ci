...
func Test_DeploymentTextOutput(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expect: [][]string{
				{"DeploymentID", "BuildID", "CreatedAt", "IdleTimeoutEnabled", "RoomsPerProcess", "RequestedCPU", "RequestedMemory", "DefaultContainerPort", "AdditionalContainerPorts", "BuildTag", "DeploymentTag", "ExperimentalRequestedGPU", "FleetID", "RequestedGPU"},
				{"dep-2", "bld-1", "2021-01-01T00:00:00Z", "true", "3", "0.5", "1.0", "GiB", "default:3000/tcp", "debug:4000/tcp", "null", "null", "null", "null", "null"},
			},
		},
		{
...
func Test_BuildTextOutput(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expect: [][]string{
				{"BuildID", "BuildTag", "CreatedAt", "Status", "ImageSize", "StartedAt", "FinishedAt", "ContentHash", "ExpiredAt", "OrgID", "ShareURL"},
				{"bld-1", "v1.0.0", "2021-01-01T00:00:00Z", "status", "2.0", "KiB", "2021-01-01T00:00:00Z", "null", "null", "null", "null"},
			},
		},
		{
