...
// DiscoveryV1 - Service that allows clients to directly ping all Hathora regions to get latency information
...
func (s *DiscoveryV1) GetPingServiceEndpoints(ctx context.Context) (*operations.GetPingServiceEndpointsResponse, error) {
