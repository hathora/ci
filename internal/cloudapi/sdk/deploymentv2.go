...
// DeploymentV2 - Operations that allow you configure and manage an application's [build](https://hathora.dev/docs/concepts/hathora-entities#build) at runtime.
type DeploymentV2 struct {
	sdkConfiguration sdkConfiguration
}

func newDeploymentV2(sdkConfig sdkConfiguration) *DeploymentV2 {
	return &DeploymentV2{
...
func (s *DeploymentV2) GetDeployments(ctx context.Context, appID *string) (*operations.GetDeploymentsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out []shared.DeploymentV2
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeploymentV2s = out
		default:
...
func (s *DeploymentV2) GetLatestDeployment(ctx context.Context, appID *string) (*operations.GetLatestDeploymentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *DeploymentV2) GetDeploymentInfo(ctx context.Context, deploymentID int, appID *string) (*operations.GetDeploymentInfoResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *DeploymentV2) CreateDeployment(ctx context.Context, buildID int, deploymentConfigV2 shared.DeploymentConfigV2, appID *string) (*operations.CreateDeploymentResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
